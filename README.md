...
<ul>
  <li><h3>MAP</h3>
    <p>The initial map as heatmap of overall incidents, than can be filtered by the categories desired; can be scrolled or selected by county and filtered by the main categories in every layer of itOverall city incidents but when clicked in an specific zone, it zooms in and clusters the incidents.</p>
  </li>
  ...
  <li><h3>TRENDS GRAPH</h3>
    <p>Overall data line plot with filters for all the categories and timeline available.</p>
  </li>
</ul>
