...
var tooltip = d3.select("#grafico2")
    .append("div")
    .style("opacity", 0)
    .attr("class", "tooltip")
...
var showTooltip = function(d) {
    ...
    tooltip
        .style("opacity", 1)
        .html("" + d.Entidad + " " + d.Tdecesoscienmh)
...
var legendOrdinal = d3.legendColor()
    ...
    .cellFilter(function(d) { return d.Catdesc !== "d" })
    .scale(ordinal);
...
svg.append("text")
    ...
    .attr("font-weight", "bold")
    .style("fill", "white")
    .text("Tasa de decesos por accidentes viales *c 1000,000 hab, México 2018");
...
d3.csv("/static/scripts/tasas4.csv", function(error, tasas) {
